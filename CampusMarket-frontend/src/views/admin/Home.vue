    ...
    <div class="menu-container">
        <div class="menu-side" :class="{ 'menu-side-narrow': flag }">
            <div style="display: flex;align-items: center;">
                <Logo name="校园跳蚤" style="padding: 0 40px;margin: 15px 0;" :flag="flag" :bag="colorLogo" />
            </div>
            ...
            <el-row style="padding: 10px 20px 20px 20px;">
                <el-row>
                    ...
                    <el-upload class="avatar-uploader"
                        action="http://localhost:31451/api/campus-product-sys/v1.0/file/upload" :show-file-list="false"
