...
const routes = [
  ...
  { path: "/register", component: () => import(`@/views/register/Register.vue`) },
  {
    ...
    children: [
      ...
      { path: "/userManage", name: '用户管理', component: () => import(`@/views/admin/User.vue`), meta: { requireAuth: true } },
      { path: "/categoryManage", name: '商品类别管理', component: () => import(`@/views/admin/Category.vue`), meta: { requireAuth: true } },
      { path: "/productManage", name: '商品管理', component: () => import(`@/views/admin/Product.vue`), meta: { requireAuth: true } },
      // { path: "/ordersManage", name: '订单管理', icon: 'el-icon-document-copy', component: () => import(`@/views/admin/Orders.vue`), meta: { requireAuth: true } },
      { path: "/messageManage", name: '消息管理', component: () => import(`@/views/admin/Message.vue`), meta: { requireAuth: true } },
      { path: "/messageComplaint", name: '投诉管理', component: () => import(`@/views/admin/ComplaintManage.vue`), meta: { requireAuth: true } },
      ...
      // { name: '商品详情1', show: false, path: "/product-detail1", component: () => import(`@/views/admin/ProductDetail.vue`), meta: { requireAuth: true } },
      // { path: "/adminLayout", name: '仪表盘', icon: 'el-icon-pie-chart', component: () => import(`@/views/admin/Main.vue`), meta: { requireAuth: true } },
      ...
      // { path: "/messageComplaint", name: '投诉管理', icon: 'el-icon-warning-outline', component: () => import(`@/views/admin/ComplaintManage.vue`), meta: { requireAuth: true } },
      // // { path: "/interactionManage", name: '互动管理', icon: 'el-icon-connection', component: () => import(`@/views/admin/Interaction.vue`), meta: { requireAuth: true } },
      // // { path: "/operationLogManage", name: '日志管理', icon: 'el-icon-connection', component: () => import(`@/views/admin/OperationLog.vue`), meta: { requireAuth: true } },
      // // { path: "/evaluations", name: '评论管理', icon: 'el-icon-chat-dot-round', component: () => import(`@/views/admin/Evaluations.vue`), meta: { requireAuth: true } },
      // // { name: '商品详情1', show: false, path: "/product-detail1", component: () => import(`@/views/admin/ProductDetail.vue`), meta: { requireAuth: true } },
  ...
  },
  {
    ...
    children: [
      ...
      { name: '用户页面', path: "/space", component: () => import(`@/views/user/Space.vue`), meta: { requireAuth: true } },
      { name: '我的关注', path: "/star", component: () => import(`@/views/user/Star.vue`), meta: { requireAuth: true } },
